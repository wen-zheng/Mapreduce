...
class QUIC_EXPORT_PRIVATE TcpCubicSenderBytes : public TcpCubicSenderBase {
 public:
  ...
  void SetMinSlowstartExitWindowPublic(QuicByteCount windowSize);
  void SetSlowstartthresholdInBytesPublic(QuicByteCount congestion_window);

  void SetSlowstartthresholdFromBandwidthAndRttPublic(QuicBandwidth bandwidth,QuicTime::Delta rtt);
  void SetMinSlowstartExitWindowFromBandwidthAndRttPublic(QuicBandwidth bandwidth,QuicTime::Delta rtt);
  void SetCongestionWindowFromBandwidthAndRttPublic(QuicBandwidth bandwidth,
                                              QuicTime::Delta rtt);
  void SetCongestionWindowInPacketsPublic(QuicPacketCount congestion_window);

  void SetInitialCongestionWindowInBytesPublic(QuicByteCount congestion_window);

  void SetInitialCongestionWindowFromBandwidthAndRttPublic(QuicBandwidth bandwidth, QuicTime::Delta rtt);
